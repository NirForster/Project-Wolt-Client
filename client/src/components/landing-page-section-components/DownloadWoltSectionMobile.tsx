const DownloadWoltSectionMobile = () => {
  return (
    <div className="sm:pt-16  mb-40 bg-[#f2f3f5] flex flex-col justify-center w-full sm:h-[758px] mt-[100px] overflow-hidden">
      <div className="flex items-center w-full max-w-[1200px] h-full mx-auto p-4 pb-6  relative sm:p-4 sm:pb-6">
        <div className="z-[1] sm:max-w-full md:max-w-[60%]">
          <h2 className="antialiased text-[2.875rem] leading-[3.5rem] font-woltHeader text-[#202125] mb-10 font-bold tracking-normal">
            <span data-localization-key="get-wolt.get-app-title">
              Honey, we’re not cooking tonight
            </span>
          </h2>
          <p className="text-[#707174] mb-10 leading-[1.71] text-[16px]">
            <span data-localization-key="get-wolt.get-app-text">
          ...
          <a
            className="w-full max-w-[10rem] mb-4 block object-contain"
            href="https://wolt.onelink.me/Uy67?af_adset=not-available-web-to-app&amp;af_keywords=not-available-web-to-app&amp;af_r=https%3A%2F%2Fitunes.apple.com%2Ffi%2Fapp%2Fwolt%2Fid943905271%3Fmt%3D8&amp;af_sub1=not-available-web-to-app&amp;af_sub2=%2Fen%2Fisr&amp;c=not-available-web-to-app&amp;pid=not-available-web-to-app"
            data-platform="ios"
            target="_blank"
          ...
          <a
            className="w-full max-w-[10rem] mb-4 block object-contain"
            href="https://wolt.onelink.me/Uy67?af_adset=not-available-web-to-app&amp;af_keywords=not-available-web-to-app&amp;af_r=https%3A%2F%2Fplay.google.com%2Fstore%2Fapps%2Fdetails%3Fid%3Dcom.wolt.android&amp;af_sub1=not-available-web-to-app&amp;af_sub2=%2Fen%2Fisr&amp;c=not-available-web-to-app&amp;pid=not-available-web-to-app"
          ...
          >
            <img
              className="w-full max-w-[10rem] mb-4 block object-contain"
              src="https://wolt-com-static-assets.wolt.com/images/android-en-096765c5c3aea81be926.png"
      ...
      <div className="w-auto h-auto">
        <img
          src="https://consumer-static-assets.wolt.com/frontpage-assets/front-cells-mobile.jpg"
          alt=""
        />
      </div>
    </div>
...
export default DownloadWoltSectionMobile;
